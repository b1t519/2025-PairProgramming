async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    greedy_snake_step(n, snake, snakeNum, otherSnakes, foodNum, foods, round) {
      ...
      otherSnakes = __retain(__lowerTypedArray(Int32Array, 4, 2, otherSnakes) || __notnull());
      foods = __lowerTypedArray(Int32Array, 4, 2, foods) || __notnull();
      try {
        return exports.greedy_snake_step(n, snake, snakeNum, otherSnakes, foodNum, foods, round);
      } finally {
        __release(snake);
